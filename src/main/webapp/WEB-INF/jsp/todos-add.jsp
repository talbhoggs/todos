...
<body>
	...
	<div class="container-fluid">
		...
		<br />
		<!-- In spring 5 commandName is remove -->
		<%-- <form:form method="post" modelAttribute="todo">  --%>
		<!-- https://stackoverflow.com/questions/46989072/org-apache-jasper-jasperexception-web-inf-views-home-jsp-line-25-column?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa -->
